...
class RCTGAN:
    ...
    Args:
        model (type):
            Class of the model to use. Defaults to ``rctgan.relational.RCTGAN``.
        model_kwargs (dict):
    ...
    def fit(self, metadata, tables=None, root_path=None):
        """Fit this sdvrctgan instance to the dataset data.
    ...
    def save(self, path):
        """Save this sdvrctgan instance to the given path using pickle.
    ...
    @classmethod
    def load(cls, path):
        """Load a sdvrctgan instance from a given path.
